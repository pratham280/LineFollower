...
This code is purely line following and works on odd ir array sensor
Note:
      This was observed during testing that sensors which are present in the middle should be closely packed so that it may result in better resolution
*/
// Constants
